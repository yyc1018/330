...
results1 = np.load('/Users/katherine.yychow/Downloads/pydream_results 3/parapop_sampled_params_chain_0.npy')
results2 = np.load('/Users/katherine.yychow/Downloads/pydream_results 3/parapop_sampled_params_chain_1.npy')
results3 = np.load('/Users/katherine.yychow/Downloads/pydream_results 3/parapop_sampled_params_chain_2.npy')
results4 = np.load('/Users/katherine.yychow/Downloads/pydream_results 3/parapop_sampled_params_chain_3.npy')
results5 = np.load('/Users/katherine.yychow/Downloads/pydream_results 3/parapop_sampled_params_chain_4.npy')
...
log_paramVals_burnIn.columns = ["log(k0) (/s)", "log(\u03B1)", "log(\u03B6300)", "log(\u03B6500)", "log(\u03B61300)", "log(\u03B2)"]
paramNames = ["log(k0) (/s)", "log(\u03B1)", "log(\u03B6300)", "log(\u03B6500)", "log(\u03B61300)", "log(\u03B2)"]
